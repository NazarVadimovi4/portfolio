print('Уважаемые пассажиры, добро пожаловать на рейс Аэрофлота SU1234.\n'
'Этот рейс выполняется на самолете Боинг 777-300ER.\n'
'В нашем самолете 350 мест. \n'    
'Все места по 7000 рублей, кроме аварийных 30A и 30F, которые стоят 8000 рублей.')
